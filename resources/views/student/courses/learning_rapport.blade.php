    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                ...
                <div class="flex items-center">
                    @if($passed)
                    <p class="p-[16px_20px] rounded-[10px] bg-[#09c432] font-bold text-lg text-white outline-[#0ab92a] outline-dashed outline-[3px] outline-offset-[7px] mr-[10px]">Passed</p>
                    @else
                    <p class="p-[16px_20px] rounded-[10px] bg-[#bc0606] font-bold text-lg text-white outline-[#bc0606] outline-dashed outline-[3px] outline-offset-[7px] mr-[10px]">Not Passed</p> -->
                    @endforelse
                </div>
            </div>
            <div class="result flex flex-col gap-5 mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="question-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                    ...
                    @else 
                        <div class="flex items-center gap-[14px]">
                            <p class="bg-[#bc0606] rounded-full p-[8px_20px] text-white font-semibold text-sm">{{$answer->answer}}</p>
                        </div>
                    @endforelse
