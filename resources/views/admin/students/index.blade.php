            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex gap-6 items-center">
                    ...
                    <div class="flex flex-col gap-5">
                        <h1 class="font-extrabold text-[30px] leading-[45px]">{{$course->name}}1</h1>
            ...
            <div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="flex flex-col gap-5 mt-2">
                    <div class="student-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                        ...
                        @if(strtolower($student->status) == 'passed')
                        ...
                        @elseif(strtolower($student->status) == 'not started')
                            <div class="flex items-center gap-[14px]">
                                <p class="p-[6px_10px] rounded-[10px] bg-[#b8a304] font-bold text-xs text-white outline-[#b8a304] outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">Not Started</p>
                            </div>
                        @elseif(strtolower($student->status) == 'not passed')
                            <div class="flex items-center gap-[14px]">
                                <p class="p-[6px_10px] rounded-[10px] bg-[#bc1206] font-bold text-xs text-white outline-[#bc1206] outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">Not Passed</p>
                            </div>
                        @endif
                ...
                @empty
                <p>
                    Belum ada student yang terdaftar di kelas ini.
                </p>
                @endforelse
            </div>
        </div>
